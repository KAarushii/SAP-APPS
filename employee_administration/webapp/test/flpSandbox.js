		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#employeeadministration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeeadministration-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeeadministration",
									"url": sap.ui.require.toUrl("employeeadministration")
								}
							}
						}
					}
